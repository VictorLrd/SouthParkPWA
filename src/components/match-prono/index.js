      ...
      <Container>
        <ContainerInfo>
          ...
          <ContainerMatch>
            ...
            <ContainerMatchInfo>
              <ContainerInfoTeamDom>RB Leipzig</ContainerInfoTeamDom>
              <LogoDom src={logoDom}></LogoDom>{' '}
              <ContainerScore>
                <ScoreDomicile defaultValue=' ? ' />{' '}
                <ScoreExterieur defaultValue=' ? ' />
              </ContainerScore>{' '}
              <LogoExt src={logoExt}></LogoExt>{' '}
              <ContainerInfoTeamExt>Tottenham</ContainerInfoTeamExt>{' '}
            </ContainerMatchInfo>
          </ContainerMatch>
        </ContainerInfo>
      </Container>
